...
// -------------------------------------------------------------------------------------------
// COPY/PASTE OF LitDepthNormals.hlsl FROM THE URP LIRBARY.
// MODIFIED SLIGHTLY SO THAT IT CAN SUPPORT NORMAL MAP SCALING IN WORLD SPACE.
// -------------------------------------------------------------------------------------------
...
struct Varyings
{
    ...
    float3 positionWS               : TEXCOORD6; // ADDED
...
Varyings DepthNormalsVertex(Attributes input)
{
    ...
    output.positionWS = vertexInput.positionWS; // ADDED
...
half4 DepthNormalsFragment(Varyings input) : SV_TARGET
{
    ...
    #else
        float2 uv = input.positionWS.xz; // CHANGED FROM UV TO WORLD POSITION XZ
