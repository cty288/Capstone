Shader "Universal Render Pipeline/Custom/SandTerrain"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "DesertTerrainInputs.hlsl"
            #include "DesertTerrainPasses.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "DesertTerrainInputs.hlsl"
            #include "DesertTerrainNormalPass.hlsl"
            ENDHLSL
        }
