...
namespace _02._Scripts.Runtime.WeaponParts.Model.Instance.Time.Magazines.ArtificialAdaptedMagazine {
	public class ArtificialAdaptedMagazine : WeaponPartsEntity<ArtificialAdaptedMagazine, ArtificialAdaptedMagazineBuff> {
		[field: ES3Serializable]
		public override string EntityName { get; set; } = "ArtificialAdaptedMagazine";
	...
	public class ArtificialAdaptedMagazineBuff : WeaponPartsBuff<ArtificialAdaptedMagazine, ArtificialAdaptedMagazineBuff> {
		[field: ES3Serializable]	
