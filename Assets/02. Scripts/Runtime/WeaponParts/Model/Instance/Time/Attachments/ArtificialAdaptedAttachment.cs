...
using _02._Scripts.Runtime.WeaponParts.Model.Instance.Mineral.Attachments;
using Polyglot;
...
namespace _02._Scripts.Runtime.WeaponParts.Model.Instance.Attachments {
	public class ArtificialAdaptedAttachment : WeaponPartsEntity<ArtificialAdaptedAttachment,ArtificialAdaptedAttachmentBuff> {
		[field: ES3Serializable]
		public override string EntityName { get; set; } = "ArtificialAdaptedAttachment";
	...
	public class ArtificialAdaptedAttachmentBuff : WeaponPartsBuff<ArtificialAdaptedAttachment,
			ArtificialAdaptedAttachmentBuff> {
			...
			return new List<GetResourcePropertyDescriptionGetter>() {
				new GetResourcePropertyDescriptionGetter(() => {
					...
					return new WeaponBuffedAdditionalPropertyDescription(iconName, title,
						Localization.GetFormat("ArtificialAdaptedAttachment_desc", displayMultiplayer));
				})
			};
		}
	}
