...
namespace _02._Scripts.Runtime.WeaponParts.Model.Instance.Test {
	public class TestWeaponParts7 : WeaponPartsEntity<TestWeaponParts7, TestWeaponPartBuff7> {
		[field: ES3Serializable]
		public override string EntityName { get; set; } = "TestWeaponParts7";
	...
	public class TestWeaponPartBuff7 : WeaponPartsBuff<TestWeaponParts7, TestWeaponPartBuff7> {
		[field: ES3Serializable]
