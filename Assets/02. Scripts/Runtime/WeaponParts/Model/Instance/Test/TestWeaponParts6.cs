...
namespace _02._Scripts.Runtime.WeaponParts.Model.Instance.Test {
	public class TestWeaponParts6 : WeaponPartsEntity<TestWeaponParts6, TestWeaponPartBuff6> {
		[field: ES3Serializable]
		public override string EntityName { get; set; } = "TestWeaponParts6";
	...
	public class TestWeaponPartBuff6 : WeaponPartsBuff<TestWeaponParts6, TestWeaponPartBuff6> {
		[field: ES3Serializable]
