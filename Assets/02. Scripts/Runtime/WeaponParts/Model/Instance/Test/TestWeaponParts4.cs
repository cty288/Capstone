...
namespace _02._Scripts.Runtime.WeaponParts.Model.Instance.Test {
	public class TestWeaponParts4 : WeaponPartsEntity<TestWeaponParts4, TestWeaponPartBuff4> {
		[field: ES3Serializable]
		public override string EntityName { get; set; } = "TestWeaponParts4";
	...
	public class TestWeaponPartBuff4 : WeaponPartsBuff<TestWeaponParts4, TestWeaponPartBuff4> {
		[field: ES3Serializable]
