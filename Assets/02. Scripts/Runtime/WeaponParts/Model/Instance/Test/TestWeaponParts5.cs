...
namespace _02._Scripts.Runtime.WeaponParts.Model.Instance.Test {
	public class TestWeaponParts5 : WeaponPartsEntity<TestWeaponParts5, TestWeaponPartBuff5> {
		[field: ES3Serializable]
		public override string EntityName { get; set; } = "TestWeaponParts5";
	...
	public class TestWeaponPartBuff5 : WeaponPartsBuff<TestWeaponParts5, TestWeaponPartBuff5> {
		[field: ES3Serializable]
