...
namespace _02._Scripts.Runtime.WeaponParts.Model.Instance.Combat.Barrels.ShreddingAdaptedBarrel {
	public class ShreddingAdaptedBarrel : WeaponPartsEntity<ShreddingAdaptedBarrel, ShreddingAdaptedBarrelBuff> {
		[field: ES3Serializable]
		public override string EntityName { get; set; } = "ShreddingAdaptedBarrel";
	...
	public class ShreddingAdaptedBarrelBuff : WeaponPartsBuff<ShreddingAdaptedBarrel, ShreddingAdaptedBarrelBuff> {
		[field: ES3Serializable]	
