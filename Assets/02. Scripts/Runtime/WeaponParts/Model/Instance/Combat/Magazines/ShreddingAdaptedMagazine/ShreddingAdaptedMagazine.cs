...
namespace _02._Scripts.Runtime.WeaponParts.Model.Instance.Combat.Magazines.ShreddingAdaptedMagazine {
	public class ShreddingAdaptedMagazine : WeaponPartsEntity<ShreddingAdaptedMagazine, ShreddingAdaptedMagazineBuff> {
		[field: ES3Serializable]
		public override string EntityName { get; set; } = "ShreddingAdaptedMagazine";
	...
	public class ShreddingAdaptedMagazineBuff : WeaponPartsBuff<ShreddingAdaptedMagazine, ShreddingAdaptedMagazineBuff> {
		[field: ES3Serializable]	
