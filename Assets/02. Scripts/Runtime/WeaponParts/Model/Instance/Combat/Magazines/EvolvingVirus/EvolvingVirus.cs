...
namespace _02._Scripts.Runtime.WeaponParts.Model.Instance.Combat.Magazines.EvolvingVirus {
	...
	public class EvolvingVirusBuff : WeaponPartsBuff<EvolvingVirus, EvolvingVirusBuff> {
		...
		public override void OnInitialize() {
			weaponEntity.RegisterOnModifyValueEvent<OnCombatBuffChangeDurationEvent>(OnModifyDurationEvent);
		}

		private OnCombatBuffChangeDurationEvent OnModifyDurationEvent(OnCombatBuffChangeDurationEvent e) {
		...
		public override void OnRecycled() {
			weaponEntity.UnRegisterOnModifyValueEvent<OnCombatBuffChangeDurationEvent>(OnModifyDurationEvent);
			base.OnRecycled();
		}
