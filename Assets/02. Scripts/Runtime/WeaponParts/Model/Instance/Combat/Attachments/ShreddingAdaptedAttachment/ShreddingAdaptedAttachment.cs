...
namespace _02._Scripts.Runtime.WeaponParts.Model.Instance.Combat.Attachments.ShreddingAdaptedAttachment {
	public class ShreddingAdaptedAttachment : WeaponPartsEntity<ShreddingAdaptedAttachment,ShreddingAdaptedAttachmentBuff> {
		[field: ES3Serializable]
		public override string EntityName { get; set; } = "ShreddingAdaptedAttachment";
	...
	public class ShreddingAdaptedAttachmentBuff : WeaponPartsBuff<ShreddingAdaptedAttachment,
		ShreddingAdaptedAttachmentBuff> {
			...
			return new List<GetResourcePropertyDescriptionGetter>() {
				new GetResourcePropertyDescriptionGetter(() => {
					...
					return new WeaponBuffedAdditionalPropertyDescription(iconName, title,
						Localization.GetFormat("ShreddingAdaptedAttachment_desc", displayMultiplayer));
				})
			};
		}
	}
