...
namespace _02._Scripts.Runtime.WeaponParts.Model.Instance.Mineral.Magazines.EMPAdaptedMagazine {
	public class EMPAdaptedMagazine : WeaponPartsEntity<EMPAdaptedMagazine, EMPAdaptedMagazineBuff> {
		[field: ES3Serializable]
		public override string EntityName { get; set; } = "EMPAdaptedMagazine";
	...
	public class EMPAdaptedMagazineBuff : WeaponPartsBuff<EMPAdaptedMagazine, EMPAdaptedMagazineBuff> {
		[field: ES3Serializable]	
