...
namespace _02._Scripts.Runtime.WeaponParts.Model.Instance.Mineral.Barrels.ExecutorBarrel {
	...
	public class ExecutorBarrelBuff : WeaponPartsBuff<ExecutorBarrel, ExecutorBarrelBuff> {
			...
			return new List<GetResourcePropertyDescriptionGetter>() {
				new GetResourcePropertyDescriptionGetter(() => {
					...
					return new WeaponBuffedAdditionalPropertyDescription(iconName, title,
						Localization.GetFormat("ExecutorBarrel_desc", healthThreshold, displayedMultiplier));
				})
			};
		}
	}
