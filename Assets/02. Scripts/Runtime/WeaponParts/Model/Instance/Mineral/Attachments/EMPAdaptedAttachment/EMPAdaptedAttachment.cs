...
namespace _02._Scripts.Runtime.WeaponParts.Model.Instance.Mineral.Attachments.EMPAdaptedAttachment {
	public class EMPAdaptedAttachment : WeaponPartsEntity<EMPAdaptedAttachment,EMPAdaptedAttachmentBuff> {
		[field: ES3Serializable]
		public override string EntityName { get; set; } = "EMPAdaptedAttachment";
	...
	public class EMPAdaptedAttachmentBuff : WeaponPartsBuff<EMPAdaptedAttachment,
		EMPAdaptedAttachmentBuff> {
			...
			return new List<GetResourcePropertyDescriptionGetter>() {
				new GetResourcePropertyDescriptionGetter(() => {
					...
					return new WeaponBuffedAdditionalPropertyDescription(iconName, title,
						Localization.GetFormat("EMPAdaptedAttachment_desc", displayMultiplayer));
				})
			};
		}
	}
