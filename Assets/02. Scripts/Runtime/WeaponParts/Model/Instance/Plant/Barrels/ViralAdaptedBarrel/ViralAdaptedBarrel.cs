...
namespace _02._Scripts.Runtime.WeaponParts.Model.Instance.Plant.Barrels.ViralAdaptedBarrel {
	public class ViralAdaptedBarrel : WeaponPartsEntity<ViralAdaptedBarrel, ViralAdaptedBarrelBuff> {
		[field: ES3Serializable]
		public override string EntityName { get; set; } = "ViralAdaptedBarrel";
	...
	public class ViralAdaptedBarrelBuff : WeaponPartsBuff<ViralAdaptedBarrel, ViralAdaptedBarrelBuff> {
		[field: ES3Serializable]	
