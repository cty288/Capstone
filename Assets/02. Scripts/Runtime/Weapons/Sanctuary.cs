...
{
    public class SanctuaryEntity : WeaponEntity<SanctuaryEntity>
    {
    ...
    public class Sanctuary : AbstractHitScanWeaponViewController<SanctuaryEntity>
    {
        ...
        protected override IEntity OnInitWeaponEntity(WeaponBuilder<SanctuaryEntity> builder) {
