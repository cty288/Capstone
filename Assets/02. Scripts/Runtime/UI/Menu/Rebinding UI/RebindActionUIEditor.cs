...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUIEditor : UnityEditor.Editor
    {
        protected void OnEnable()
        {
            ...
            m_CanDuplicareProperty = serializedObject.FindProperty("m_CanDuplicate");
            ...
            m_BindingDuplicateEventProperty = serializedObject.FindProperty("m_bindingDuplicateEvent");
            duplicateWhitelistProperty = serializedObject.FindProperty("duplicateWhitelist");
        ...
        public override void OnInspectorGUI()
        {
            ...
            using (new EditorGUI.IndentLevelScope())
            {
                ...
                m_CanDuplicareProperty.boolValue = EditorGUILayout.Toggle("Can Duplicate", m_CanDuplicareProperty.boolValue);
                EditorGUILayout.PropertyField(duplicateWhitelistProperty, new GUIContent("Duplicate Whitelist"), true);
            }
            ...
            using (new EditorGUI.IndentLevelScope())
            {
                ...
                EditorGUILayout.PropertyField(m_BindingDuplicateEventProperty);
            }
        ...
        private SerializedProperty m_BindingDuplicateEventProperty;
        private SerializedProperty m_CanDuplicareProperty;
        private SerializedProperty duplicationTextProperty;
        private SerializedProperty duplicateWhitelistProperty;
