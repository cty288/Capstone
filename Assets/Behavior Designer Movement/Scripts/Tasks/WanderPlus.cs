...
namespace BehaviorDesigner.Runtime.Tasks.Movement
{
    ...
    public class WanderPlus : NavMeshMovement
    {
        ...
        {
            NavMeshHit hit;
            bool foundPosition = NavMesh.SamplePosition(this.gameObject.transform.position + Random.insideUnitSphere * 10, out hit, 10, NavMesh.AllAreas);
